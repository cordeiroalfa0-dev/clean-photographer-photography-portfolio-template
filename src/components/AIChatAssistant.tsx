      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[360px] h-[500px] bg-background border border-border rounded-2xl shadow-2xl overflow-hidden flex flex-col"
          >
            {/* Header */}
            ...
            <ScrollArea className="flex-1 p-4" ref={scrollRef}>
              {messages.length === 0 && (
                <div className="text-center text-muted-foreground py-8">
                  ...
                  <p className="text-xs mt-2">Pergunte sobre ensaios, preços ou agende uma sessão.</p>
                </div>
              )}
              {messages.map((msg, i) => (
                <motion.div
